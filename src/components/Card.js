...
export class Card extends Component {
  render() {
    return (
      <div className='relative w-[49%]  sky_blue_hover card_responsive'>
      <div className='bg-white rounded    border-b border-b-[1px] border-b-[#ced5df] h-[510px]'>
          <div className='relative  ' >
            
            <img src={img} className="rounded object-cover w-full h-[340px] card_image_size" alt="" />
            <div className='bg-white z-10 w-6 h-6 rounded-full absolute top-2 right-2 flex items-center justify-center opacity-80 '>
          ...
          <h1 className='text-xl text-[#4f5864]'>Luxury 5-Star Auckland Stay at Cordis </h1>
            <p className='text-[#01b2ee]'>Cordis</p>
            <p className='text-[#92a2ad]'>Auckland</p>
            <span className='text-sky_blue ml-[89%] text-sm'>from</span> 
            <div className='flex justify-between items-end'>
               <span className='text-[#92a2ad]'>370 bought</span> 
               <div className='mr-4'><span className='line-through text-[#727986]'>$580</span><span className='text-sky_blue text-3xl'> $279</span></div>
            </div>
          </div>
      </div>
      </div>
