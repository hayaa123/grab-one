...
export class CardSmall extends Component {
  render() {
    return (
        ...
        <div className='relative w-[25%] pr-[1%]  small_card_responsive'>
        <div className='bg-white rounded  w-full  border-b border-b-[1px] border-b-[#ced5df] sky_blue_hover_small '>
